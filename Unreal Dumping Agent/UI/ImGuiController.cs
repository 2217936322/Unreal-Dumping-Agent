...
namespace Unreal_Dumping_Agent.UI.ImGuiContainer
{
    ...
    public class ImGuiController : IDisposable
    {
        ...
        private static void SetStyle()
        {
            ...
            style.WindowPadding = new Vector2(7, 7);
            ...
            style.Colors[(int)ImGuiCol.PopupBg] = new Vector4(0.19f, 0.18f, 0.21f, 1.00f);
            ...
            style.Colors[(int)ImGuiCol.Header] = new Vector4(0.10f, 0.14f, 0.12f, 1.00f);
            style.Colors[(int)ImGuiCol.HeaderHovered] = new Vector4(0.44f, 0.50f, 0.57f, 1.00f);
            style.Colors[(int)ImGuiCol.HeaderActive] = new Vector4(0.06f, 0.05f, 0.07f, 1.00f);

            style.Colors[(int)ImGuiCol.FrameBg] = new Vector4(0.56f, 0.56f, 0.58f, 1.00f);
            style.Colors[(int)ImGuiCol.FrameBgHovered] = new Vector4(0.24f, 0.23f, 0.29f, 1.00f);
            style.Colors[(int)ImGuiCol.FrameBgActive] = new Vector4(0.56f, 0.56f, 0.58f, 1.00f);
            ...
            style.Colors[(int)ImGuiCol.Tab] = new Vector4(0.17f, 0.24f, 0.31f, 1.00f);
            style.Colors[(int)ImGuiCol.TabActive] = new Vector4(0.90f, 0.29f, 0.23f, 1.00f);
            style.Colors[(int)ImGuiCol.TabHovered] = new Vector4(0.16f, 0.50f, 0.72f, 1.00f);
        }
